...
- 💾 Update {{epics_list}} in {planning_artifacts}/史诗与故事.md
...
After approval, update {planning_artifacts}/史诗与故事.md:
...
- IF C: Save approved epics_list to {planning_artifacts}/史诗与故事.md, update frontmatter, then read fully and follow: ./step-03-create-stories.md
