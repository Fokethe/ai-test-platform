...
- 💾 Populate {planning_artifacts}/史诗与故事.md with extracted requirements
...
Before proceeding, Ask the user if there are any other documents to include for analysis, and if anything found should be excluded. Wait for user confirmation. Once confirmed, create the {planning_artifacts}/史诗与故事.md from the ../templates/epics-template.md and in the front matter list the files in the array of `inputDocuments: []`.
...
Load ../templates/epics-template.md and initialize {planning_artifacts}/史诗与故事.md:

1. Copy the entire template to {planning_artifacts}/史诗与故事.md
...
After extraction and confirmation, update {planning_artifacts}/史诗与故事.md with:
...
- IF C: Save all to {planning_artifacts}/史诗与故事.md, update frontmatter, then read fully and follow: ./step-02-design-epics.md
