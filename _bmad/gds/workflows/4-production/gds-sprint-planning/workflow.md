...
1. **Search for whole document first** - Look for `史诗与故事.md`, `gds-epics.md`, or any `*epic*.md` file
...
**Fuzzy matching**: Be flexible with document names - users may use variations like `史诗与故事.md`, `gds-epics.md`, `user-stories.md`, etc.
