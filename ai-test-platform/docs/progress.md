...
- API 响应示例:
  ```json
  {
    "data": {
      "testCases": [...],
      "meta": {
        "model": { "id": "qwen-3", "name": "千问 3" },
        "cost": { "estimatedCost": 0.001, "usageStats": {...} },
        "rag": { "enabled": true, "similarCasesCount": 5 }
      }
    }
  }
  ```
...
#### TDD �� 17 ����� ?
- **����Ԥ��ҳ����� modelId ����** - ֧�ִ� URL ���ղ�����ģ�Ͳ���
- 6 ����������� + 31 ���ع����ȫ��ͨ������ 37 �����ԣ�
- �����ļ�:
  - src/app/(dashboard)/ai-generate/testcases/__tests__/model-param.test.tsx - ģ�Ͳ�������
  - src/app/(dashboard)/ai-generate/testcases/page.tsx - ����Ϊ���� modelId ����
- ��������:
  - �� URL ������ȡ modelId`n  - ��֤ģ�� ID ��Ч�ԣ���Чʱ���˵�Ĭ��ֵ��
  - Ĭ��ģ��: kimi-k2.5
  - API ����ʱ���� modelId ����
  - ҳ����ʾ��ǰʹ�õ�ģ����Ϣ����ɫ��ʾ��Ƭ��
  - ֧��ģ��: kimi-k2.5, qwen-3
