...
# -*- coding: utf-8 -*-
"""
将Markdown格式的测试用例转换为Excel文件（带格式）
"""
...
def main():
    ...
    output_file = r"f:\test\skills\productivity\doc-based-testcase-generator\testcases\钢结构检测管理系统\钢结构检测管理系统_功能测试用例.xlsx"
