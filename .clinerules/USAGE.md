...
| `/yolo` | 进入自动执行模式（无需确认） | Global Tools |
...
| `/compact` | 压缩上下文（自动保存状态） | Global Tools |
...
| 指令 | 功能 | 所属 Skill |
|------|------|-----------|
| `/acceptance` | 启动44检查点全自动验收 (YOLO模式+SubAgent TDD自动修复循环) | Project Acceptance Expert |
...
| # | Skill 名称 | 文件位置 | 说明 |
|---|-----------|---------|------|
| 00 | 全局基础工具 | `skills/skill-00-global-tools.md` | 路径验证+编码修复+检查点追踪+同步清单，所有Skills共享 |
...
| 14 | 第三方验收专家 V5.1 ⭐⭐ | `skills/skill-14-project-acceptance.md` | 56检查点(44+12)+运行时验证+严格模式(100%+99+99%)+YOLO/Compact实际执行+SubAgent并行验收 |
...
└── Skill 14: 第三方验收专家 V5.1 - 56检查点+运行时验证+严格模式(100%+99+99%)+YOLO/Compact实际执行
...
| 🎯 编排调度 | 2个 | - |
| 🧹 项目维护 | 1个 | - |
*配置版本: 2.3 | 最后更新: 2026-03-12 | 核心 Skill: 14个*
| **总计** | **15个** | **300+项** |

*配置版本: 2.4 | 最后更新: 2026-03-12 | 核心 Skill: 15个 (新增 Skill 00 全局基础工具 + Skill 14 升级至 V5.1)*
================================================================================
*配置版本: 2.3 | 最后更新: 2026-03-12 | 核心 Skill: 14个*
